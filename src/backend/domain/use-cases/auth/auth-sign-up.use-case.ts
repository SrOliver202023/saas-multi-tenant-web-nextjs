...
type IResponseAuthSignUp = Either<Error, { account: Account; user: User }>;
...
export class AuthSignUpUseCase {
  ...
  async execute(payload: IRequestAuthSignUp): Promise<IResponseAuthSignUp> {
    try {
